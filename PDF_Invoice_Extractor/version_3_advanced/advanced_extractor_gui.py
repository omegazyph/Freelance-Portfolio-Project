...
class ProfessionalExtractorGUI:
    ...
    def create_ui(self):
        ...
        branding_frame.pack(fill="x", 
                            pady=(5, 15)
                            )

        script_dir = os.path.dirname(os.path.abspath(__file__))
        logo_path = os.path.join(script_dir, 
                                 "logo.png"
                                 )
        ...
        try:
            ...
            logo_label = tk.Label(branding_frame, 
                                  image=self.logo_img, 
                                  bg="#f0f2f5"
                                  )
        ...
        header = ttk.Label(branding_frame, 
        ...
        selection_frame = tk.LabelFrame(main_frame, 
        ...
        input_row = tk.Frame(selection_frame, 
                             bg="white"
                             )
        ...
        ttk.Label(selection_frame, 
                  ...
                  background="white").pack(anchor="w")
        output_row = tk.Frame(selection_frame, 
                              bg="white"
                              )
    ...
    def run_process(self):
        ...
        if total_files == 0:
            self.log(
                "Notice: No PDF files found in the selected folder."
            )
        ...
        try:
            with open(output_file, "a", newline="") as csv_file:
                ...
                for index, filename in enumerate(
                    ...
                    self.log(
                        f"Processing ({index}/{total_files}): {filename}"
                    )
                    ...
                    try:
                        with pdfplumber.open(full_path) as pdf:
                            ...
                            if not text or not text.strip():
                                self.log(
                                    f"Warning: {filename} appears to be an image/scan. Skipping."
                                )
                            ...
                            if money_match:
                                ...
                                # Convert string "$1,200.50" to float 1200.50 for math
            ...
            # professional Summary Popup[cite:4]
            summary_msg = (
            ...
            # Enable the Open Report button[cite: 2]
